  ...
  return (
    <div ref={skillsRef} className="w-full p-4 md:p-6 lg:px-12" id="experience">
      <div className="max-w-custom mx-auto py-16 md:py-28">
        ...
        >
          <b>Blotic | Web Dev Intern (Dec '23 – Mar '24):</b> Worked with a team of 5+ developers through the full project lifecycle, from planning to deployment, ahead of schedule. Developed a community platform, used productivity tools like Notion for project management, and improved team efficiency by 20%.
        </motion.p>
